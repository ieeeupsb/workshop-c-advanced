...
/**
 * \brief devolve uma "copia" da tabela origianal mas com tamanho diferente, eliminando a tabela original no processo
 * \param td tabela de dispersao
 * \return "copia" da tabela de dispersao ou NULL se nao existir tabela ou se a tabela original estiver vazia
 */
tabela_dispersao* tabela_move(tabela_dispersao *td, int tamanho);
